...
sinasc = pd.read_csv('./input/SINASC_RO_2019_'+sys.argv[2]+'.csv')
...
sinasc = pd.read_csv('./input/SINASC_RO_2019_'+sys.argv[3]+'.csv')
...
sinasc = pd.read_csv('./input/SINASC_RO_2019_'+sys.argv[4]+'.csv')
...
sinasc = pd.read_csv('./input/SINASC_RO_2019_'+sys.argv[5]+'.csv')
